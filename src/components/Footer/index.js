...
import ShareIcon from '@mui/icons-material/Share';import TwitterIcon from "@mui/icons-material/Twitter";
import { RWebShare } from "react-web-share";
import { APP_URL } from "../../constants";
function Footer() {
  return (
    <div id="footer" className="footer-wrapper">
      <h1 className="heading">CryptoClassic.</h1>
      <div className="socials">
        ...
        >
          <ShareIcon className="socialIcons" />
        </RWebShare>
      </div>
    </div>
  );
